...
class PreferencesDataStoreImpl(private val preferencesDataStore: DataStore<Preferences>):
    ...
    override suspend fun setIsAppLockEnable(isAppLockEnabled: Boolean) {
        preferencesDataStore.updateData { currentPreferencesData ->
    ...
    override suspend fun getIsAppLockEnable(): Boolean {
        return preferencesDataStore.data.first().isAppLockEnabled
    }

    override fun getIsAppLockEnableFlow(): Flow<Boolean> {
        return preferencesDataStore.data.map { preferences ->
